...
ActiveRecord::Schema.define(version: 20150218102403) do
  ...
  add_index "recipes", ["restaurant_id"], name: "index_recipes_on_restaurant_id", using: :btree
  ...
  create_table "saved_recipes", force: true do |t|
    t.integer  "user_id"
    t.integer  "recipe_id"
    t.datetime "created_at"
    t.datetime "updated_at"
